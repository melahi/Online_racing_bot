...
class ScoreReader:
    def __init__(self):
        ...
        self.steps = 1000
        self.score_grabber = ScoreGrabber()
...
def main():
    ...
    # score_reader.predicting(path="./grabbed_score/")
    # score_grabber = ScoreGrabber()
    # score_reader.predict_and_save(score_grabber.grab_scores(), "grabbed_score_new")
